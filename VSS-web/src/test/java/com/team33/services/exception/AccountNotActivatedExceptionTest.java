...
@Transactional
public class AccountNotActivatedExceptionTest {
    
    public AccountNotActivatedExceptionTest() {
    }
    ...
    public void testConstructor_String() {
        String string = "foo";
        AccountNotActivatedException e = new AccountNotActivatedException(string);
    ...
    public void testConstructor_StringThrowable() {
        ...
        AccountNotActivatedException e = new AccountNotActivatedException(string, throwable);
